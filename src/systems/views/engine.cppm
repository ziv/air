...
public:
    void draw(entt::registry &registry) override {
        ...
        const auto [player, inputs] = registry.get<Player, PlayerInputs>(entity);

        const auto view = registry.view<Position2D, EngineWidget>();
...
private:
    static void drawEngine(const PlayerInputs &inputs, const Vector2 &center) {
