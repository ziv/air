...
export
{
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(AircraftConfig, weight, engineThrust, vleSpeed, liftCoefficient, liftSlopeCoefficient, stallAngle, dragCoefficient,
                                       inducedDragCoefficient, pitchRatio, rollRatio, yawRatio);
}
